...
export const PREMIUM_CSS = [
  ...
  ".pg-logo{display:block;object-fit:contain;flex:0 0 auto}",
  ".pg-logo--cover{height:44px;width:auto;max-width:240px}",
  ".pg-logo--sign{height:40px;width:auto;max-width:170px}",
