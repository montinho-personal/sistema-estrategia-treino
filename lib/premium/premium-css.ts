...
export const PREMIUM_CSS = [
  ...
  ".pg-report__t{font-size:17px;font-weight:640;letter-spacing:-.01em;margin:0 0 12px;break-after:avoid;page-break-after:avoid}",
  ".pg-report__h{font-size:14.5px;font-weight:680;color:var(--pg-ink);letter-spacing:-.01em;margin:18px 0 8px;break-after:avoid;page-break-after:avoid}",
  ".pg-report__p{font-size:14px;line-height:1.68;color:#33343a;margin:0 0 13px}",
  ...
  ".pg-block__x{font-size:13px;color:#33343a;margin-top:8px;line-height:1.5}",
  ".pg-block__xl{font-weight:640;color:var(--pg-ink)}",
  ".pg-box p + p{margin-top:8px;color:var(--pg-mut);font-size:13px}",
